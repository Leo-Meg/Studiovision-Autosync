...
class SingleInstanceGuard:
    """Verrou Windows empêchant le lancement simultané de plusieurs instances."""
    ...
    def acquire(self) -> bool:
        self.handle = win32event.CreateMutex(None, True, self.mutex_name)
...
def main() -> None:
    ...
    log.info("Version 3 started - single-instance guard enabled")
...
if __name__ == "__main__":
    guard = SingleInstanceGuard(
        r"Global\StudiovisionAutosync_ImageRouter_V2"
    )
